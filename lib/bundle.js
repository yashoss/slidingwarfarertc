	  ...
	  connection.onmessage = function(message) {
	    ...
	    function onOffer(offer, name) {
	      ...
	      myConnection.createAnswer(function(answer) {
	        ...
	        gameTitleEl.remove();
	        const newGame = new GameView(ctx, selectedUser, myName, dataChannel);
	        newGame.start();
	    ...
	    function onAnswer(answer) {
	      ...
	      gameTitleEl.remove();
	      const newGame = new GameView(ctx, myName, selectedUser, dataChannel);
	      newGame.start();
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	class Game {
	  constructor(name1, name2, dataChannel) {
	    this.shooters = [];
	    this.walls = [];
	    this.bullets = [];
	    this.bases = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	class GameView {
	  constructor(ctx, name1, name2, dataChannel) {
	    this.game = new Game(name1, name2, dataChannel);
	    this.ctx = ctx;
	    this.actionCount = 0;
